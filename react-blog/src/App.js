      ...
      <Container fluid className="overflow-hidden" style={{
        ...
        <div className="d-flex flex-row align-item-start text-left" style={{ fontFamily: "Noto Sans JP" }}>
          ...
          <Routes>
            ...
            <Route path="/Nikki/:article" element={<RenderPage link={"/Nikki"} />} />
          </Routes>
        </div>
      </Container>
    </BrowserRouter>
...
const Tabs = () => {
  ...
  return (
    <div className="d-flex align-items-start flex-column flex-wrap" style={{ width: "30vw",height: "80vh" }}>
      ...
      <Link to="/Nikki" href="/page5" className={`mt-auto tab ${isFinish5 ? "corsorhover" : "tab-slide5"}`} style={{ fontSize: "18px", marginTop: "20px", marginLeft: "20px" }} onAnimationEnd={AnimationFinish5}>雑記</Link>
    </div>
  );
};
